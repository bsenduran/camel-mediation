 ...
 * under the License.
 */
package org.wso2.carbon.camel.mediation.common;

/**
 * Class to keep the contants required for Camel Mediation implementation
 */
public class CamelMediationConstants {
